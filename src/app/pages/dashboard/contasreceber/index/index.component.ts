...
export class IndexComponent implements OnInit {
  ...
  async ngOnInit() {
    this._api.obterContasAReceberHojeRecebido().then((res: any) => {
    ...
    this._api.obterContasAReceberMesRecebido().then((res: any) => {
      for (let index = 0; index < res.length; index++) {
    ...
    this._api.obterContasAReceberAnoRecebido().then((res: any) => {
      for (let index = 0; index < res.length; index++) {
    ...
    this._api.obterContasAReceberHojeAberto().then((res: any) => {
      for (let index = 0; index < res.length; index++) {
    ...
    this._api.obterContasAReceberMesAberto().then((res: any) => {
      for (let index = 0; index < res.length; index++) {
    ...
    this._api.obterContasAReceberAnoAberto().then((res: any) => {
      for (let index = 0; index < res.length; index++) {
    ...
    await this._api.obterContasAReceberMesBaixadoByID(1).then((data: any) => {
      for (let index = 0; index < data.length; index++) {
        this.mes1baixado = this.mes1baixado + data[index].saldo;
      }
    });
    await this._api.obterContasAReceberMesBaixadoByID(2).then((data: any) => {
      for (let index = 0; index < data.length; index++) {
        this.mes2baixado = this.mes2baixado + data[index].saldo;
      }
    });
    await this._api.obterContasAReceberMesBaixadoByID(3).then((data: any) => {
      for (let index = 0; index < data.length; index++) {
        this.mes3baixado = this.mes3baixado + data[index].saldo;
      }
    });
    await this._api.obterContasAReceberMesBaixadoByID(4).then((data: any) => {
      for (let index = 0; index < data.length; index++) {
        this.mes4baixado = this.mes4baixado + data[index].saldo;
      }
    });
    await this._api.obterContasAReceberMesBaixadoByID(5).then((data: any) => {
      for (let index = 0; index < data.length; index++) {
        this.mes5baixado = this.mes5baixado + data[index].saldo;
      }
    });
    await this._api.obterContasAReceberMesBaixadoByID(6).then((data: any) => {
      for (let index = 0; index < data.length; index++) {
        this.mes6baixado = this.mes6baixado + data[index].saldo;
      }
    });
    await this._api.obterContasAReceberMesBaixadoByID(7).then((data: any) => {
      for (let index = 0; index < data.length; index++) {
        this.mes7baixado = this.mes7baixado + data[index].saldo;
      }
    });
    await this._api.obterContasAReceberMesBaixadoByID(8).then((data: any) => {
      for (let index = 0; index < data.length; index++) {
        this.mes8baixado = this.mes8baixado + data[index].saldo;
      }
    });
    await this._api.obterContasAReceberMesBaixadoByID(9).then((data: any) => {
      for (let index = 0; index < data.length; index++) {
        this.mes9baixado = this.mes9baixado + data[index].saldo;
      }
    });
    await this._api.obterContasAReceberMesBaixadoByID(10).then((data: any) => {
      for (let index = 0; index < data.length; index++) {
        this.mes10baixado = this.mes10baixado + data[index].saldo;
      }
    });
    await this._api.obterContasAReceberMesBaixadoByID(11).then((data: any) => {
      for (let index = 0; index < data.length; index++) {
        this.mes11baixado = this.mes11baixado + data[index].saldo;
      }
    });
    await this._api.obterContasAReceberMesBaixadoByID(12).then((data: any) => {
      for (let index = 0; index < data.length; index++) {
        this.mes12baixado = this.mes12baixado + data[index].saldo;
      }
    });

    await this._api.obterContasAReceberMesAbertoByID(1).then((data: any) => {
      for (let index = 0; index < data.length; index++) {
        this.mes1aberto = this.mes1aberto + data[index].saldo;
      }
    });
    await this._api.obterContasAReceberMesAbertoByID(2).then((data: any) => {
      for (let index = 0; index < data.length; index++) {
        this.mes2aberto = this.mes2aberto + data[index].saldo;
      }
    });
    await this._api.obterContasAReceberMesAbertoByID(3).then((data: any) => {
      for (let index = 0; index < data.length; index++) {
        this.mes3aberto = this.mes3aberto + data[index].saldo;
      }
    });
    await this._api.obterContasAReceberMesAbertoByID(4).then((data: any) => {
      for (let index = 0; index < data.length; index++) {
        this.mes4aberto = this.mes4aberto + data[index].saldo;
      }
    });
    await this._api.obterContasAReceberMesAbertoByID(5).then((data: any) => {
      for (let index = 0; index < data.length; index++) {
        this.mes5aberto = this.mes5aberto + data[index].saldo;
      }
    });
    await this._api.obterContasAReceberMesAbertoByID(6).then((data: any) => {
      for (let index = 0; index < data.length; index++) {
        this.mes6aberto = this.mes6aberto + data[index].saldo;
      }
    });
    await this._api.obterContasAReceberMesAbertoByID(7).then((data: any) => {
      for (let index = 0; index < data.length; index++) {
        this.mes7aberto = this.mes7aberto + data[index].saldo;
      }
    });
    await this._api.obterContasAReceberMesAbertoByID(8).then((data: any) => {
      for (let index = 0; index < data.length; index++) {
        this.mes8aberto = this.mes8aberto + data[index].saldo;
      }
    });
    await this._api.obterContasAReceberMesAbertoByID(9).then((data: any) => {
      for (let index = 0; index < data.length; index++) {
        this.mes9aberto = this.mes9aberto + data[index].saldo;
      }
    });
    await this._api.obterContasAReceberMesAbertoByID(10).then((data: any) => {
      for (let index = 0; index < data.length; index++) {
        this.mes10aberto = this.mes10aberto + data[index].saldo;
      }
    });
    await this._api.obterContasAReceberMesAbertoByID(11).then((data: any) => {
      for (let index = 0; index < data.length; index++) {
        this.mes11aberto = this.mes11aberto + data[index].saldo;
      }
    });
    await this._api.obterContasAReceberMesAbertoByID(12).then((data: any) => {
      for (let index = 0; index < data.length; index++) {
    ...
    this._api.obterContasAReceberMesCategoriaBaixadoByID().then((data: any) => {
      console.log(data);
    ...
    this._api.obterContasAReceberMesCategoriaAbertoByID().then((data: any) => {
